...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    missionMarket: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    whoWeAreText: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalContentGlobalContent extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global settings like Navigation, Footer, etc.';
    displayName: 'Global Content';
  ...
  attributes: {
    ...
    siteTitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'UNTH.AI'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    titleHeader: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLeadFormLeadForm extends Struct.SingleTypeSchema {
  collectionName: 'lead_forms';
  info: {
    description: 'Content for the Lead Form section';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sendingMessage: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNewsletterNewsletter extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Newsletter section content';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Services offered by UNTH.AI';
    displayName: 'Service';
    pluralName: 'services';
